...
from coal_train_cup.services.tipping_service import get_tips_for_user
import pandas as pd
from coal_train_cup.services.games_service import all_game_results
from coal_train_cup.services.leaderboard_service import get_full_results_dataframe, get_leaderboard_dataframe
...
def page_view_user_tips() -> None:
    ...
    if user:
        ...
        user_display_df = user_display_df[["round", "team", "home", "opponent", "result", "margin"]]
